---
title: VIEWE 2.8" 240X320 ESP32-S3 Smart Touch Display
description: UEDX24320028E-WB-A is 2.8" 240X320 ESP32-S3 Smart Touch Display Uart Display 
---

# 2.8" 240x320 ESP32-S3 Smart Touch Display
...
-   **UEDX24320028E-WB-A**
    ...
    [:material-github: GitHub Repo](https://github.com/VIEWESMART/UEDX24320028ESP32-2.8inch-Touch-Display){ .md-button }

</div>

<div align="center"> 
  <img src="../../../assets/images/UEDX24320028E-WB-A/2.8 inch esp32 tft touch display.jpg" width="100%" alt="2.8 inch esp32 tft touch display">
...
<p align="left">
  <img src="../../../assets/images/UEDX24320028E-WB-A/module.jpg" alt="Module Overview" width="70%">
</p>
...
- **Hardware:** UEDX24320028E-WB-A_WB_A Board, USB-C Cable.
...
6. **Config esp supported panel board:**
   Open the `esp_panel_board_supported_conf.h` file in the example. Enable this file: change the `ESP_PANEL_BOARD_DEFAULT_USE_SUPPORTED` macro definition to `1`. Ensure you uncomment: `#define BOARD_VIEWE_UEDX24320028E-WB-A`
...
!!! tip "Configuration Note"
    ...
    `#define BOARD_VIEWE_UEDX24320028E-WB-A_WB_A`
...
3. **Configure PlatformIO:**
   This example uses the `BOARD_ESPRESSIF_ESP32_S3_LCD_EV_BOARD_2_V1_5` board as default. Choose `BOARD_VIEWE_UEDX24320028E-WB-A_WB_A` in the `[platformio]:default_envs` of the `platformio.ini` file.
