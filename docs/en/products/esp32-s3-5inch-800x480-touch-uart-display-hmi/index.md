---
title: VIEWE 5.0" 800x480 ESP32-S3 Smart Touch Display
description: UEDX80480050E-WB is 5.0" 800x480 ESP32-S3 Smart Touch Display RGB Display with Wi-Fi & BLE 5.
---

# 5.0" 800x480 ESP32-S3 Smart Touch Display
...
-   **UEDX80480050E-WB**
    ---
    The High-Performance Smart Display powered by ESP32-S3. Featuring a 5.0-inch 800x480 RGB Display (IPS) with Capacitive Touch Screen, Wi-Fi & BLE 5, and rich expansion interfaces.

    [:material-arrow-left: Back to Series](../esp32/){ .md-button }
    [:material-cart: Official Store](https://viewedisplay.com/product/esp32-5-inch-800x480-rgb-ips-tft-display-touch-screen-arduino-lvgl/){ .md-button .md-button--primary }
    [:material-github: GitHub Repo](https://github.com/VIEWESMART/UEDX80480050ESP32-5inch-Touch-Display){ .md-button }

</div>

<div align="center">
  <img src="../../../assets/images/UEDX80480050E-WB/UEDX80480050E-WB.jpg" width="100%" alt="5.0 inch esp32 tft touch display">
</div>
...
!!! note "Board Migration Notice"
    The UEDX80480050E-WB-A development board will be gradually phased out and replaced by the UEDX80480050E-WB-B development board. New designs are recommended to migrate to this version.
...
- Two 2x21 Pin Headers breaking out multiple programmable GPIOs (SPI, UART, I2C, I2S, LCD, Camera, USB OTG, etc.).
...
!!! note "Screen Variants"
    We have two types of screens (IPS TFT and Transflective TFT). They are identical except for the different lengths of the touch cables in hardware. We will select and match the screens based on available inventory and your request.
...
<div align="center">
  <img src="../../../assets/images/UEDX80480050E-WB/Layout.jpg" width="80%" alt="5.0 inch esp32 tft touch display interface">
</div>

1. **Main Control Chip**: ESP32S3-MCN16R8 (Dual-core, up to 240MHz)
2. **Display Interface**: 40-Pin RGB 24-bit output (R0-R7, G0-G7, B0-B7). Only RGB565 is usable due to chip limitations.
3. **SD Card Slot**: SPI interface for external storage expansion.
4. **Touch Interface**: I2C (SDA/SCL) + Interrupt + Reset pins for GT911 CTP.
5. **USB Type-C**: 5V DC power supply & programming.
6. **UART Serial Port**: Standard TX/RX for debugging or communication.
7. **RGB-LED**: WS2812B onboard.
8. **Boot Buttons**: BOOT (GPIO0) for download mode; 
9. **Reset Buttons**: RESET (CHIP-EN) for system reset.
10. **4-pin 1.25mm Header**: Optional I2C/UART breakout. Remove RGB LEDs if interference is a concern.
11. **External GPIO Headers**: Dual-row 2x21 headers providing ADC, touch sensors, and digital I/O.

!!! note "Touch Interface Selection"
...
<div align="center">
  <img src="../../../assets/images/UEDX80480050E-WB/GPIO.png" width="80%" alt="5.0 inch esp32 tft touch display gpio">
</div>

!!! note "GPIO18 Configuration"
...
<div align="center">
  <img src="../../../assets/images/UEDX80480050E-WB/Functional.jpg" width="100%" alt="5.0 inch esp32 tft touch display function">
</div>
...
!!! tip "Novice Tutorial"
    Refer to the [Arduino Getting Started Tutorial](../../support/tutorials.md) for detailed guidance.
...
!!! tip "Configuration"
    In `esp_panel_board_supported_conf.h`, ensure you uncomment: `#define BOARD_VIEWE_UEDX80480050E_WB_A`. Do not enable both `ESP_PANEL_BOARD_DEFAULT_USE_SUPPORTED` and `ESP_PANEL_BOARD_DEFAULT_USE_CUSTOM`. You cannot enable multiple esp supported panel boards at the same time.
...
| Document | Link |
| :--- | :--- |
| Product Specification (WB-A) | [UEDX80480050E-WB-A.pdf](../../../assets/datasheet/UEDX80480050E-WB-A.pdf) |
| Product Specification (WB-B) | [UEDX80480050E-WB-B.pdf](../../../assets/datasheet/UEDX80480050E-WB-B.pdf) |
| ESP32-S3-WROOM-1 (CN) | [esp32-s3-wroom-1_datasheet_cn.pdf](../../../assets/datasheet/chip/esp32-s3-wroom-1_wroom-1u_datasheet_cn.pdf) |
| ESP32-S3-WROOM-1 (EN) | [esp32-s3-wroom-1_datasheet_en.pdf](../../../assets/datasheet/chip/esp32-s3-wroom-1_wroom-1u_datasheet_en.pdf) |
<!-- | Schematic Diagram (WB-A) | [UEDX48480050E-WB-A V1.3 SCH.pdf](../../../assets/schematic/UEDX48480050E-WB-A%20V1.3.SCH.pdf) |
| Schematic Diagram (WB-B) | [UEDX80480050E-WB-B.pdf](../../../assets/schematic/UEDX80480050E-WB-B.pdf) |
| 2D Drawing (DWG) | [PLCM-DX80480050E-WB-B.dwg](../../../assets/dimension/PLCM-DX80480050E-WB-B.dwg) |
| Display Specification | [UE050WV-RB40-A070A V1.0.pdf](../../../assets/datasheet/UE050WV-RB40-A070A_V1.0.pdf) |
| Display Chip (ST7262) | [ST7262.pdf](../../../assets/datasheet/ST7262.pdf) |
| Touch Chip GT911 (CN) | [GT911_CN_Datasheet.pdf](../../../assets/datasheet/GT911_CN_Datasheet.pdf) |
| Touch Chip GT911 (EN) | [GT911_EN_Datasheet.pdf](../../../assets/datasheet/GT911_EN_Datasheet.pdf) | -->
