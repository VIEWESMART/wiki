---
title: VIEWE 3.5" 320x480 ESP32-S3 Smart Touch Display
description: UEDX32480035E-WB-A is 3.5" 320x480 ESP32-S3 Smart Touch Display Uart Display 
---

# 3.5" 320x480 ESP32-S3 Smart Touch Display
...
-   **UEDX32480035E-WB-A**
    ---
    The Mainstream AIoT Smart Display powered by ESP32-S3. Featuring a 3.5-inch 320x480 IPS TFT Display with Capacitive Touch Screen, Wi-Fi & BLE 5, and rich expansion interfaces.

    [:material-arrow-left: Back to Series](../esp32/){ .md-button }
    [:material-cart: Official Store](https://viewedisplay.com/product/esp32-3-5-inch-320x480-mcu-ips-tft-display-touch-screen-arduino-lvgl-wifi-ble-uart-smart-module/){ .md-button .md-button--primary }
    [:material-github: GitHub Repo](https://github.com/VIEWESMART/UEDX24320028ESP32-3.5inch-320_480-Display){ .md-button }

</div>

<div align="center"> 
  <img src="../../../assets/images/UEDX32480035E-WB-A/3.5 inch esp32 tft touch display.jpg" width="100%" alt="3.5 inch esp32 tft touch display">
...
The UEDX32480035E-WB-A is a high-performance HMI smart display module equipped with a 3.5-inch SPI screen (320x480). Powered by the ESP32-S3-WROOM-1-N16R8 module, it integrates 2.4GHz Wi-Fi and Bluetooth 5 (LE) capabilities.
...
- **Memory:**
    ...
    - 8MB Octal SPI PSRAM.
- **Display & Touch:**
    - Screen: 3.5-inch TFT LCD (320x480 Resolution).
...
<p align="left">
  <img src="../../../assets/images/UEDX32480035E-WB-A/module.jpg" alt="Module Overview" width="70%">
</p>
...
- **Hardware:** UEDX32480035E-WB-A_WB_A Board, USB-C Cable.
...
6. **Config esp supported panel board:**
   Open the `esp_panel_board_supported_conf.h` file in the example. Enable this file: change the `ESP_PANEL_BOARD_DEFAULT_USE_SUPPORTED` macro definition to `1`. Ensure you uncomment: `#define BOARD_VIEWE_UEDX32480035E-WB-A_WB_A`
...
!!! tip "Configuration Note"
    ...
    `#define BOARD_VIEWE_UEDX32480035E-WB-A`
...
3. **Configure PlatformIO:**
   This example uses the `BOARD_ESPRESSIF_ESP32_S3_LCD_EV_BOARD_2_V1_5` board as default. Choose `BOARD_VIEWE_UEDX32480035E-WB-A_WB_A` in the `[platformio]:default_envs` of the `platformio.ini` file.
...
| Document | Link |
| :--- | :--- |
| Product Specification | [UEDX32480035E-WB-A.pdf](../../../assets/datasheet/UEDX32480035E-WB-A.pdf) |
| Schematic Diagram | [SCH-UEDX32480035E-WB-A.pdf](../../../assets/schematic/SCH-UEDX24320028E-WB-A.png) |
| 2D Drawing (DWG) | [UEDX32480035E-WB-A.dwg](../../../assets/dimension/) |
