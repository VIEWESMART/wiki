...
<figure markdown="span" class="displaywiki-figure">
  [![Resistive Touchscreen Technology (RTP)](touch-panel-types-resistive-touchscreen-technology-rtp.png){ width="760" loading="lazy" }](touch-panel-types-resistive-touchscreen-technology-rtp.png){ .displaywiki-image-link title="Open full-size image" }
...
<figure markdown="span" class="displaywiki-figure">
  [![Resistive Touchscreens Advantages](touch-panel-types-resistive-touchscreens-advantages.jpeg){ width="760" loading="lazy" }](touch-panel-types-resistive-touchscreens-advantages.jpeg){ .displaywiki-image-link title="Open full-size image" }
